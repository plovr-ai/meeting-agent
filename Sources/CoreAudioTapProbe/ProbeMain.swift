...
struct ProbeMain {
    ...
    private static func printTargets(_ targets: [AudioCaptureTarget]) {
        ...
        log("")
        log("Usage: CoreAudioTapProbe [--pid <process-id>] [--seconds 10] [--wav [capture.wav]] [--stt-provider local|whisper] [--stt-locale en-US] [--target-locale zh-CN] [--bilingual-profile local-whisper-hosted-translation]")
