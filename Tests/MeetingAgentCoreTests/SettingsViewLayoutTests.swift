...
final class SettingsViewLayoutTests: XCTestCase {
    func testSettingsViewUsesPickersForAllEditableFields() throws {
        ...
        XCTAssertTrue(source.contains("SettingsCommandCenterPanel(\"Post-Meeting Refinement\")"))
        XCTAssertTrue(source.contains("Picker(\"Batch Transcript Provider\""))
        XCTAssertTrue(source.contains("Picker(\"Batch Transcript Model\""))
        XCTAssertTrue(source.contains("SpeechProviderCatalog.batchTranscriptionModelOptions"))
