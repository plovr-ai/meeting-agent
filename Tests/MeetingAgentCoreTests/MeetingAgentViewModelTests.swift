...
final class MeetingAgentViewModelTests: XCTestCase {
    ...
    func testExportHelpersWriteSummaryDataAndReadinessReports() throws {
        ...
        let readiness = try String(contentsOf: readinessDestination, encoding: .utf8)
        XCTAssertTrue(readiness.contains("## Transcript Quality"))
        XCTAssertTrue(readiness.contains("- Source: liveOnly"))
        XCTAssertTrue(readiness.contains("- Final turns: 1"))
